...
export default function BrochureDownload({
  ...
  const handleSubmit = async (e) => {
    ...
    const data = {
      ...
      project_name: "The Quiet Side by DivyaSree",
    };
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="bg-primary btn-gradient-animation text-white  cursor-pointer flex flex-col items-center gap-1 px-[4px] py-1 self-start transition duration-200"
        >
          <span
