          ...
          <div className="flex items-center justify-between h-14">
            ...
            <Link href="/" className="flex items-center gap-2">
              <img
                ...
                alt="The Quiet Side by DivyaSree"
            ...
            <nav className="hidden lg:flex items-center space-x-4">
                  ...
                  <Link
                    ...
                    className={`font-medium transition px-3 py-2 ${
                      isActive
                        ...
                        : "text-gray-700 hover:text-[#1d3283]"
                    }`}
                  >
                    {item.name}
                  </Link>
              ...
              <button
                ...
                className="font-medium cursor-pointer transition px-3 py-2 text-gray-700 hover:text-[#1d3283]"
              >
                Brochure
              </button>
            </nav>
      ...
      >
        <div className="p-6 space-y-4">
          ...
          <button
            ...
            className="block cursor-pointer w-full text-left px-3 py-2 font-medium text-gray-700 hover:text-[#1d3283]"
          >
            Brochure
          </button>
