    ...
    <>
      <div className="flex gap-3 mb-4">
        ...
        <button
          ...
          className="flex-1 flex items-center cursor-pointer justify-center gap-2 border-2 border-[#1d3283] text-primary hover:bg-blue-50 font-semibold py-3 rounded-full text-sm transition-colors"
        >
          <FaDownload />
          Brochure
        </button>
